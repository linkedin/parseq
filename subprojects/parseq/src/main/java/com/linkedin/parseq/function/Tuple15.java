...
public class Tuple15<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> implements Tuple {
  ...
  public Tuple15(final T1 t1, final T2 t2, final T3 t3, final T4 t4, final T5 t5, final T6 t6, final T7 t7, final T8 t8, final T9 t9, final T10 t10, final T11 t11, final T12 t12, final T13 t13, final T14 t14, final T15 t15) {
    _1 = t1;
    _2 = t2;
    _3 = t3;
    _4 = t4;
  ...
  public <C> C map(final Function15<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, C> f) throws Exception {
  ...
  public boolean equals(Object other) {
      if(other instanceof Tuple15) {
          Tuple15<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?> that = (Tuple15<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?>) other;
  ...
  public String toString() {
      return "("
       ...
       + ", " + Objects.toString(_14)
       + ", " + Objects.toString(_15)
              + ")";
  }
