...
public class Tuple11TaskDelegate<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> implements Tuple11Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> {

  private final Task<Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> _task;

  public Tuple11TaskDelegate(Task<Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> task) {
    _task = task;
  }
   ...
   */
  @Override
  public Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> get() throws PromiseException {
    return _task.get();
  }
   ...
   */
  @Override
  public Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> getOrDefault(Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> defaultValue) throws PromiseUnresolvedException {
   ...
   */
  @Override
  public void addListener(PromiseListener<Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> listener) {
