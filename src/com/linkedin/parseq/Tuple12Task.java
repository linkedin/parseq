...
import com.linkedin.parseq.function.Consumer12;
import com.linkedin.parseq.function.Function12;
import com.linkedin.parseq.function.Tuple12;

public interface Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> extends Task<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> {

  /**
   * Equivalent to {@code map("map", f)}.
   * @see #map(String, Function12)
   */
  default <R> Task<R> map(final Function12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, R> f) {
    return map("map: " + _taskDescriptor.getDescription(f.getClass().getName()), tuple -> f.apply(tuple._1(), tuple._2(), tuple._3(), tuple._4(), tuple._5(), tuple._6(), tuple._7(), tuple._8(), tuple._9(), tuple._10(), tuple._11(), tuple._12()));
  }
   ...
   */
  default <R> Task<R> map(final String desc, final Function12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, R> f) {
    return map(desc, tuple -> f.apply(tuple._1(), tuple._2(), tuple._3(), tuple._4(), tuple._5(), tuple._6(), tuple._7(), tuple._8(), tuple._9(), tuple._10(), tuple._11(), tuple._12()));
  }

  /**
   * Equivalent to {@code flatMap("flatMap", f)}.
   * @see #flatMap(String, Function12)
   */
  default <R> Task<R> flatMap(final Function12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Task<R>> f) {
    return flatMap("flatMap: " + _taskDescriptor.getDescription(f.getClass().getName()), tuple -> f.apply(tuple._1(), tuple._2(), tuple._3(), tuple._4(), tuple._5(), tuple._6(), tuple._7(), tuple._8(), tuple._9(), tuple._10(), tuple._11(), tuple._12()));
  }
   ...
   */
  default <R> Task<R> flatMap(final String desc, final Function12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Task<R>> f) {
    return flatMap(desc, tuple -> f.apply(tuple._1(), tuple._2(), tuple._3(), tuple._4(), tuple._5(), tuple._6(), tuple._7(), tuple._8(), tuple._9(), tuple._10(), tuple._11(), tuple._12()));
  }

  /**
   * Equivalent to {@code andThen("andThen", consumer)}.
   * @see #andThen(String, Consumer12)
   */
  default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> andThen(final Consumer12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> consumer) {
    return cast(andThen("andThen: " + _taskDescriptor.getDescription(consumer.getClass().getName()), tuple -> consumer.accept(tuple._1(), tuple._2(), tuple._3(), tuple._4(), tuple._5(), tuple._6(), tuple._7(), tuple._8(), tuple._9(), tuple._10(), tuple._11(), tuple._12())));
  }
   ...
   */
  default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> andThen(final String desc, final Consumer12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> consumer) {
    return cast(andThen(desc, tuple -> consumer.accept(tuple._1(), tuple._2(), tuple._3(), tuple._4(), tuple._5(), tuple._6(), tuple._7(), tuple._8(), tuple._9(), tuple._10(), tuple._11(), tuple._12())));
  }
   ...
   */
  @Override
  default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> recoverWith(final String desc, final Function1<Throwable, Task<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>> f) {
   ...
   */
  @Override
  public default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> onFailure(final Consumer1<Throwable> consumer) {
   ...
   */
  @Override
  public default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> onFailure(final String desc, final Consumer1<Throwable> consumer) {
   ...
   */
  @Override
  public default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> withTimeout(final long time, final TimeUnit unit) {
   ...
   * completion of this task
   */
  default Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> withSideEffect(final String desc, Function12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Task<?>> func) {
    return cast(Task.super.withSideEffect(desc, tuple -> func.apply(tuple._1(), tuple._2(), tuple._3(), tuple._4(), tuple._5(), tuple._6(), tuple._7(), tuple._8(), tuple._9(), tuple._10(), tuple._11(), tuple._12())));
  }

  public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> cast(final Task<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> task) {
    return new Tuple12TaskDelegate<>(task);
  }
