...
public class Tuple12TaskDelegate<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> implements Tuple12Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> {

  private final Task<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> _task;

  public Tuple12TaskDelegate(Task<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> task) {
    _task = task;
  }
   ...
   */
  @Override
  public Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> get() throws PromiseException {
    return _task.get();
  }
   ...
   */
  @Override
  public Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> getOrDefault(Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> defaultValue) throws PromiseUnresolvedException {
   ...
   */
  @Override
  public void addListener(PromiseListener<Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> listener) {
