...
public class Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> implements Tuple {
  ...
  public Tuple10(final T1 t1, final T2 t2, final T3 t3, final T4 t4, final T5 t5, final T6 t6, final T7 t7, final T8 t8, final T9 t9, final T10 t10) {
    _1 = t1;
    _2 = t2;
    _3 = t3;
    _4 = t4;
  ...
  public <C> C map(final Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, C> f) throws Exception {
