...
public interface Tuple4Task<T1, T2, T3, T4> extends Task<Tuple4<T1, T2, T3, T4>> {
   ...
   * @see #map(String, Function4)
   */
  default <R> Task<R> map(final Function4<T1, T2, T3, T4, R> f) {
    return map("map: " + _taskDescriptor.getDescription(f.getClass().getName()), tuple -> f.apply(tuple._1(), tuple._2(), tuple._3(), tuple._4()));
  }
   ...
   * @see #flatMap(String, Function4)
   */
  default <R> Task<R> flatMap(final Function4<T1, T2, T3, T4, Task<R>> f) {
    return flatMap("flatMap: " + _taskDescriptor.getDescription(f.getClass().getName()), tuple -> f.apply(tuple._1(), tuple._2(), tuple._3(), tuple._4()));
  }
   ...
   * @see #andThen(String, Consumer4)
   */
  default Tuple4Task<T1, T2, T3, T4> andThen(final Consumer4<T1, T2, T3, T4> consumer) {
    return cast(andThen("andThen: " + _taskDescriptor.getDescription(consumer.getClass().getName()), tuple -> consumer.accept(tuple._1(), tuple._2(), tuple._3(), tuple._4())));
  }
