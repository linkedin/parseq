...
public interface Tuple4Task<T1, T2, T3, T4> extends Task<Tuple4<T1, T2, T3, T4>> {
  ...
  default <R> Task<R> mapOrFlatMap(final Function4<T1, T2, T3, T4, TaskOrValue<R>> f) {
    return mapOrFlatMap(tuple -> f.apply(tuple._1(), tuple._2(), tuple._3(), tuple._4()));
  }

  default <R> Task<R> mapOrFlatMap(final String desc, final Function4<T1, T2, T3, T4, TaskOrValue<R>> f) {
    return mapOrFlatMap(desc, tuple -> f.apply(tuple._1(), tuple._2(), tuple._3(), tuple._4()));
  }
  ...
  @Override
  default Tuple4Task<T1, T2, T3, T4> fallBackTo(final String desc, final Function<Throwable, Task<Tuple4<T1, T2, T3, T4>>> f) {
    return cast(fallBackTo(desc, f));
  }
  
  @Override
  default Tuple4Task<T1, T2, T3, T4> fallBackTo(final Function<Throwable, Task<Tuple4<T1, T2, T3, T4>>> f) {
