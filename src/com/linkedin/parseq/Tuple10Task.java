...
import com.linkedin.parseq.function.Consumer10;
import com.linkedin.parseq.function.Function10;
import com.linkedin.parseq.function.Tuple10;

public interface Tuple10Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> extends Task<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> {

  /**
   * Equivalent to {@code map("map", f)}.
   * @see #map(String, Function10)
   */
  default <R> Task<R> map(final Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> f) {
    return map("map: " + _taskDescriptor.getDescription(f.getClass().getName()), tuple -> f.apply(tuple._1(), tuple._2(), tuple._3(), tuple._4(), tuple._5(), tuple._6(), tuple._7(), tuple._8(), tuple._9(), tuple._10()));
  }
   ...
   */
  default <R> Task<R> map(final String desc, final Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> f) {
    return map(desc, tuple -> f.apply(tuple._1(), tuple._2(), tuple._3(), tuple._4(), tuple._5(), tuple._6(), tuple._7(), tuple._8(), tuple._9(), tuple._10()));
  }

  /**
   * Equivalent to {@code flatMap("flatMap", f)}.
   * @see #flatMap(String, Function10)
   */
  default <R> Task<R> flatMap(final Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, Task<R>> f) {
    return flatMap("flatMap: " + _taskDescriptor.getDescription(f.getClass().getName()), tuple -> f.apply(tuple._1(), tuple._2(), tuple._3(), tuple._4(), tuple._5(), tuple._6(), tuple._7(), tuple._8(), tuple._9(), tuple._10()));
  }
   ...
   */
  default <R> Task<R> flatMap(final String desc, final Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, Task<R>> f) {
    return flatMap(desc, tuple -> f.apply(tuple._1(), tuple._2(), tuple._3(), tuple._4(), tuple._5(), tuple._6(), tuple._7(), tuple._8(), tuple._9(), tuple._10()));
  }

  /**
   * Equivalent to {@code andThen("andThen", consumer)}.
   * @see #andThen(String, Consumer10)
   */
  default Tuple10Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> andThen(final Consumer10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> consumer) {
    return cast(andThen("andThen: " + _taskDescriptor.getDescription(consumer.getClass().getName()), tuple -> consumer.accept(tuple._1(), tuple._2(), tuple._3(), tuple._4(), tuple._5(), tuple._6(), tuple._7(), tuple._8(), tuple._9(), tuple._10())));
  }
   ...
   */
  default Tuple10Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> andThen(final String desc, final Consumer10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> consumer) {
    return cast(andThen(desc, tuple -> consumer.accept(tuple._1(), tuple._2(), tuple._3(), tuple._4(), tuple._5(), tuple._6(), tuple._7(), tuple._8(), tuple._9(), tuple._10())));
  }
   ...
   */
  @Override
  default Tuple10Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> recover(final Function1<Throwable, Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> f) {
   ...
   */
  @Override
  default Tuple10Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> recoverWith(final Function1<Throwable, Task<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>> f) {
   ...
   */
  @Override
  public default Tuple10Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> onFailure(final Consumer1<Throwable> consumer) {
   ...
   */
  @Override
  public default Tuple10Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> onFailure(final String desc, final Consumer1<Throwable> consumer) {
   ...
   */
  @Override
  public default Tuple10Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> withTimeout(final long time, final TimeUnit unit) {
   ...
   * completion of this task
   */
  default Tuple10Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> withSideEffect(final String desc, Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, Task<?>> func) {
    return cast(Task.super.withSideEffect(desc, tuple -> func.apply(tuple._1(), tuple._2(), tuple._3(), tuple._4(), tuple._5(), tuple._6(), tuple._7(), tuple._8(), tuple._9(), tuple._10())));
  }

  public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Tuple10Task<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> cast(final Task<Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> task) {
    return new Tuple10TaskDelegate<>(task);
  }
