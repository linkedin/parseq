...
public class AutoValidationDemosCreateAndGetRequestBuilder
    extends CreateIdEntityRequestBuilderBase<Integer, ValidationDemo, AutoValidationDemosCreateAndGetRequestBuilder>
{


    public AutoValidationDemosCreateAndGetRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
