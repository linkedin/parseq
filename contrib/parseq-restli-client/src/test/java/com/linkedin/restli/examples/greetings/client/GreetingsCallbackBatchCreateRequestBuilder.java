...
public class GreetingsCallbackBatchCreateRequestBuilder
    extends BatchCreateIdRequestBuilderBase<Long, Greeting, GreetingsCallbackBatchCreateRequestBuilder>
{


    public GreetingsCallbackBatchCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
