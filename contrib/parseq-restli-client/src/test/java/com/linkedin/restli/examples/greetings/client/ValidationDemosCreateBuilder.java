...
public class ValidationDemosCreateBuilder
    extends CreateRequestBuilderBase<Integer, ValidationDemo, ValidationDemosCreateBuilder>
{


    public ValidationDemosCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
