...
public class GreetingsCreateBuilder
    extends CreateRequestBuilderBase<Long, Greeting, GreetingsCreateBuilder>
{


    public GreetingsCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public GreetingsCreateBuilder isNullIdParam(Boolean value) {
