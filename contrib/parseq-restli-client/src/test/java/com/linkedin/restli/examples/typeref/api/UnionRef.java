...
public class UnionRef
    extends TyperefInfo
{

    private final static TyperefDataSchema SCHEMA = ((TyperefDataSchema) DataTemplateUtil.parseSchema("{\"type\":\"typeref\",\"name\":\"UnionRef\",\"namespace\":\"com.linkedin.restli.examples.typeref.api\",\"ref\":{\"type\":\"typeref\",\"name\":\"Union\",\"ref\":[\"int\",\"string\"]}}"));
