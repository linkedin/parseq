...
public class AssociationsBatchPartialUpdateBuilder
    extends BatchPartialUpdateRequestBuilderBase<CompoundKey, Message, AssociationsBatchPartialUpdateBuilder>
{


    public AssociationsBatchPartialUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
