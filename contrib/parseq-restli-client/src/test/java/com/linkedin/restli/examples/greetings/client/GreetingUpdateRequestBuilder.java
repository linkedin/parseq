...
public class GreetingUpdateRequestBuilder
    extends UpdateRequestBuilderBase<Void, Greeting, GreetingUpdateRequestBuilder>
{


    public GreetingUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
