...
public class GreetingsPromiseCtxCreateBuilder
    extends CreateRequestBuilderBase<Long, Greeting, GreetingsPromiseCtxCreateBuilder>
{


    public GreetingsPromiseCtxCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public GreetingsPromiseCtxCreateBuilder isNullIdParam(Boolean value) {
