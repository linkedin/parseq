...
public class GreetingsCallbackBatchUpdateBuilder
    extends BatchUpdateRequestBuilderBase<Long, Greeting, GreetingsCallbackBatchUpdateBuilder>
{


    public GreetingsCallbackBatchUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
