...
public class ValidationDemosCreateRequestBuilder
    extends CreateIdRequestBuilderBase<Integer, ValidationDemo, ValidationDemosCreateRequestBuilder>
{


    public ValidationDemosCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
