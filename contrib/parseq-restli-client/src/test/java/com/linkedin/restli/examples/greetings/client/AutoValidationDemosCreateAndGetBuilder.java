...
public class AutoValidationDemosCreateAndGetBuilder
    extends CreateIdEntityRequestBuilderBase<Integer, ValidationDemo, AutoValidationDemosCreateAndGetBuilder>
{


    public AutoValidationDemosCreateAndGetBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
