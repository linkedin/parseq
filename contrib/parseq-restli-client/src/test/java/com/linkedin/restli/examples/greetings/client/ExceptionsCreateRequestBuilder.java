...
public class ExceptionsCreateRequestBuilder
    extends CreateIdRequestBuilderBase<Long, Greeting, ExceptionsCreateRequestBuilder>
{


    public ExceptionsCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
