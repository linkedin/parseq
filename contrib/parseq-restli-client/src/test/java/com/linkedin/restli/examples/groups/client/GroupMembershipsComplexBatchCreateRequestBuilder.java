...
public class GroupMembershipsComplexBatchCreateRequestBuilder
    extends BatchCreateIdRequestBuilderBase<ComplexResourceKey<GroupMembershipKey, GroupMembershipParam> , ComplexKeyGroupMembership, GroupMembershipsComplexBatchCreateRequestBuilder>
{


    public GroupMembershipsComplexBatchCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public static ValidationResult validateInput(ComplexKeyGroupMembership input) {
        ...
        RestLiDataValidator validator = new RestLiDataValidator(annotations, ComplexKeyGroupMembership.class, ResourceMethod.BATCH_CREATE);
