...
public class MixedUpdateRequestBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, MixedUpdateRequestBuilder>
{


    public MixedUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
