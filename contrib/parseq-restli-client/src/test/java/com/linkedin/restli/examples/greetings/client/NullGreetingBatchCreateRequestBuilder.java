...
public class NullGreetingBatchCreateRequestBuilder
    extends BatchCreateIdRequestBuilderBase<Long, Greeting, NullGreetingBatchCreateRequestBuilder>
{


    public NullGreetingBatchCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
