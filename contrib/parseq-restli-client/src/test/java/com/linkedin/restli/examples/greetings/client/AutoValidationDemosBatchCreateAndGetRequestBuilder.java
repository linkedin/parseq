...
public class AutoValidationDemosBatchCreateAndGetRequestBuilder
    extends BatchCreateIdEntityRequestBuilderBase<Integer, ValidationDemo, AutoValidationDemosBatchCreateAndGetRequestBuilder>
{


    public AutoValidationDemosBatchCreateAndGetRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public static ValidationResult validateInput(ValidationDemo input) {
        ...
        RestLiDataValidator validator = new RestLiDataValidator(annotations, ValidationDemo.class, ResourceMethod.BATCH_CREATE);
