...
public class TyperefKeysCreateRequestBuilder
    extends CreateIdRequestBuilderBase<Long, Greeting, TyperefKeysCreateRequestBuilder>
{


    public TyperefKeysCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
