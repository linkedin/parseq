...
public class AutoValidationDemosBatchCreateBuilder
    extends BatchCreateRequestBuilderBase<Integer, ValidationDemo, AutoValidationDemosBatchCreateBuilder>
{


    public AutoValidationDemosBatchCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
