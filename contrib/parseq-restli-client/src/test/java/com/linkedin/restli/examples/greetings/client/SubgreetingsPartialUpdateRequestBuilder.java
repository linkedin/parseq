...
public class SubgreetingsPartialUpdateRequestBuilder
    extends PartialUpdateRequestBuilderBase<Long, Greeting, SubgreetingsPartialUpdateRequestBuilder>
{


    public SubgreetingsPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
