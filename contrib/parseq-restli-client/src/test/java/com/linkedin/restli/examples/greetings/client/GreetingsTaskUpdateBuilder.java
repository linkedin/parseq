...
public class GreetingsTaskUpdateBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, GreetingsTaskUpdateBuilder>
{


    public GreetingsTaskUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
