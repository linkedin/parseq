...
public class AutoValidationDemosPartialUpdateRequestBuilder
    extends PartialUpdateRequestBuilderBase<Integer, ValidationDemo, AutoValidationDemosPartialUpdateRequestBuilder>
{


    public AutoValidationDemosPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
