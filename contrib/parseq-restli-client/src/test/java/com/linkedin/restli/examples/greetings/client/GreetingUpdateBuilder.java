...
public class GreetingUpdateBuilder
    extends UpdateRequestBuilderBase<Void, Greeting, GreetingUpdateBuilder>
{


    public GreetingUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
