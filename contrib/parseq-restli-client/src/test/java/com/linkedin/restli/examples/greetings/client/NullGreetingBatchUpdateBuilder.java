...
public class NullGreetingBatchUpdateBuilder
    extends BatchUpdateRequestBuilderBase<Long, Greeting, NullGreetingBatchUpdateBuilder>
{


    public NullGreetingBatchUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
