...
public class CustomTypes3BatchUpdateBuilder
    extends BatchUpdateRequestBuilderBase<CompoundKey, Greeting, CustomTypes3BatchUpdateBuilder>
{


    public CustomTypes3BatchUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
