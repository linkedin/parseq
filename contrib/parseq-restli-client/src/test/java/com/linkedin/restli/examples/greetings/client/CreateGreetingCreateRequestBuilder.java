...
public class CreateGreetingCreateRequestBuilder
    extends CreateIdRequestBuilderBase<Long, Greeting, CreateGreetingCreateRequestBuilder>
{


    public CreateGreetingCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
