...
public class GreetingsBatchUpdateRequestBuilder
    extends BatchUpdateRequestBuilderBase<Long, Greeting, GreetingsBatchUpdateRequestBuilder>
{


    public GreetingsBatchUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
