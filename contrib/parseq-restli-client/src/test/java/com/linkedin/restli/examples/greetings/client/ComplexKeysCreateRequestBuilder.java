...
public class ComplexKeysCreateRequestBuilder
    extends CreateIdRequestBuilderBase<ComplexResourceKey<TwoPartKey, TwoPartKey> , Message, ComplexKeysCreateRequestBuilder>
{


    public ComplexKeysCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
