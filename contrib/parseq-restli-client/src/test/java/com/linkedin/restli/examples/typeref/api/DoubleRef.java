    ...
    extends TyperefInfo
{
    ...
    private final static TyperefDataSchema SCHEMA = ((TyperefDataSchema) DataTemplateUtil.parseSchema("{\"type\":\"typeref\",\"name\":\"DoubleRef\",\"namespace\":\"com.linkedin.restli.examples.typeref.api\",\"ref\":\"double\"}"));
