...
public class AnnotatedComplexKeysBatchUpdateBuilder
    extends BatchUpdateRequestBuilderBase<ComplexResourceKey<TwoPartKey, TwoPartKey> , Message, AnnotatedComplexKeysBatchUpdateBuilder>
{


    public AnnotatedComplexKeysBatchUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
