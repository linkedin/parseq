...
public class GroupsCreateRequestBuilder
    extends CreateIdRequestBuilderBase<Integer, Group, GroupsCreateRequestBuilder>
{


    public GroupsCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
