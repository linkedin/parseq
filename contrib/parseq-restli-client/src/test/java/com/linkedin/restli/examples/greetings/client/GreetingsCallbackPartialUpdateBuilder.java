...
public class GreetingsCallbackPartialUpdateBuilder
    extends PartialUpdateRequestBuilderBase<Long, Greeting, GreetingsCallbackPartialUpdateBuilder>
{


    public GreetingsCallbackPartialUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
