...
public class AutoValidationDemosCreateBuilder
    extends CreateRequestBuilderBase<Integer, ValidationDemo, AutoValidationDemosCreateBuilder>
{


    public AutoValidationDemosCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
