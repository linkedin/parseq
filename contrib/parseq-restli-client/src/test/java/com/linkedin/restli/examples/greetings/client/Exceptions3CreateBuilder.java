...
public class Exceptions3CreateBuilder
    extends CreateRequestBuilderBase<Long, Greeting, Exceptions3CreateBuilder>
{


    public Exceptions3CreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
