...
public class NullGreetingCreateBuilder
    extends CreateRequestBuilderBase<Long, Greeting, NullGreetingCreateBuilder>
{


    public NullGreetingCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
