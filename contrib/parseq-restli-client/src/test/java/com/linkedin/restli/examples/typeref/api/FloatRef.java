    ...
    extends TyperefInfo
{
    ...
    private final static TyperefDataSchema SCHEMA = ((TyperefDataSchema) DataTemplateUtil.parseSchema("{\"type\":\"typeref\",\"name\":\"FloatRef\",\"namespace\":\"com.linkedin.restli.examples.typeref.api\",\"ref\":\"float\"}"));
