...
public class GreetingsPromiseCtxBatchCreateRequestBuilder
    extends BatchCreateIdRequestBuilderBase<Long, Greeting, GreetingsPromiseCtxBatchCreateRequestBuilder>
{


    public GreetingsPromiseCtxBatchCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
