...
public class GreetingsTaskPartialUpdateBuilder
    extends PartialUpdateRequestBuilderBase<Long, Greeting, GreetingsTaskPartialUpdateBuilder>
{


    public GreetingsTaskPartialUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
