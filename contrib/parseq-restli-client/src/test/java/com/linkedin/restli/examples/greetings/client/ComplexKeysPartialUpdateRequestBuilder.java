...
public class ComplexKeysPartialUpdateRequestBuilder
    extends PartialUpdateRequestBuilderBase<ComplexResourceKey<TwoPartKey, TwoPartKey> , Message, ComplexKeysPartialUpdateRequestBuilder>
{


    public ComplexKeysPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
