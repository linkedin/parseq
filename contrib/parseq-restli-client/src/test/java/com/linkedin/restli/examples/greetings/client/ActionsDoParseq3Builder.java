...
public class ActionsDoParseq3Builder
    extends ActionRequestBuilderBase<Void, java.lang.String, ActionsDoParseq3Builder>
{


    public ActionsDoParseq3Builder(java.lang.String baseUriTemplate, Class<java.lang.String> returnClass, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
        super(baseUriTemplate, returnClass, resourceSpec, requestOptions);
        super.name("parseq3");
    }

    public ActionsDoParseq3Builder paramA(Integer value) {
        super.setReqParam(_resourceSpec.getRequestMetadata("parseq3").getFieldDef("a"), value);
        return this;
    }

    public ActionsDoParseq3Builder paramB(java.lang.String value) {
        super.setReqParam(_resourceSpec.getRequestMetadata("parseq3").getFieldDef("b"), value);
        return this;
    }

    public ActionsDoParseq3Builder paramC(Boolean value) {
