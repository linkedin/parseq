...
public class GreetingPartialUpdateBuilder
    extends PartialUpdateRequestBuilderBase<Void, Greeting, GreetingPartialUpdateBuilder>
{


    public GreetingPartialUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
