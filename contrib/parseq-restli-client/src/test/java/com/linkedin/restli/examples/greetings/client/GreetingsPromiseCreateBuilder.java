...
public class GreetingsPromiseCreateBuilder
    extends CreateRequestBuilderBase<Long, Greeting, GreetingsPromiseCreateBuilder>
{


    public GreetingsPromiseCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public GreetingsPromiseCreateBuilder isNullIdParam(Boolean value) {
