...
public class GreetingsBatchCreateBuilder
    extends BatchCreateRequestBuilderBase<Long, Greeting, GreetingsBatchCreateBuilder>
{


    public GreetingsBatchCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
