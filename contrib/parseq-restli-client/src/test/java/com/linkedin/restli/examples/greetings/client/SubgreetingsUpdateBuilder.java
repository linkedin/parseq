...
public class SubgreetingsUpdateBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, SubgreetingsUpdateBuilder>
{


    public SubgreetingsUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
