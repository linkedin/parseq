...
public class ChainedTyperefsBatchUpdateRequestBuilder
    extends BatchUpdateRequestBuilderBase<CompoundKey, Greeting, ChainedTyperefsBatchUpdateRequestBuilder>
{


    public ChainedTyperefsBatchUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
