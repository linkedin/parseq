...
public class CustomTypes2CreateBuilder
    extends CreateRequestBuilderBase<CustomLong, Greeting, CustomTypes2CreateBuilder>
{


    public CustomTypes2CreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
