...
public class GreetingsUpdateBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, GreetingsUpdateBuilder>
{


    public GreetingsUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
