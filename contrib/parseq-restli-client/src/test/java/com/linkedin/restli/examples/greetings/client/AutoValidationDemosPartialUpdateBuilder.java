...
public class AutoValidationDemosPartialUpdateBuilder
    extends PartialUpdateRequestBuilderBase<Integer, ValidationDemo, AutoValidationDemosPartialUpdateBuilder>
{


    public AutoValidationDemosPartialUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
