...
public class ComplexKeysPartialUpdateBuilder
    extends PartialUpdateRequestBuilderBase<ComplexResourceKey<TwoPartKey, TwoPartKey> , Message, ComplexKeysPartialUpdateBuilder>
{


    public ComplexKeysPartialUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
