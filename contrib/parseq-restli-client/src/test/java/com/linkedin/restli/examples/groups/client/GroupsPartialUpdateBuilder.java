...
public class GroupsPartialUpdateBuilder
    extends PartialUpdateRequestBuilderBase<Integer, Group, GroupsPartialUpdateBuilder>
{


    public GroupsPartialUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
