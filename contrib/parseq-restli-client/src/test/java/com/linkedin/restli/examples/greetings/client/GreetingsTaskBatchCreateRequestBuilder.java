...
public class GreetingsTaskBatchCreateRequestBuilder
    extends BatchCreateIdRequestBuilderBase<Long, Greeting, GreetingsTaskBatchCreateRequestBuilder>
{


    public GreetingsTaskBatchCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
