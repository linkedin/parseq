...
public class GreetingsPromiseUpdateRequestBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, GreetingsPromiseUpdateRequestBuilder>
{


    public GreetingsPromiseUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
