...
public class GreetingsBatchUpdateBuilder
    extends BatchUpdateRequestBuilderBase<Long, Greeting, GreetingsBatchUpdateBuilder>
{


    public GreetingsBatchUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
