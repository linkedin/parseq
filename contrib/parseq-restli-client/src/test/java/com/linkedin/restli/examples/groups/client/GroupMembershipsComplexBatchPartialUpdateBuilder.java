...
public class GroupMembershipsComplexBatchPartialUpdateBuilder
    extends BatchPartialUpdateRequestBuilderBase<ComplexResourceKey<GroupMembershipKey, GroupMembershipParam> , ComplexKeyGroupMembership, GroupMembershipsComplexBatchPartialUpdateBuilder>
{


    public GroupMembershipsComplexBatchPartialUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
