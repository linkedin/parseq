...
public class AssociationsCreateRequestBuilder
    extends CreateIdRequestBuilderBase<CompoundKey, Message, AssociationsCreateRequestBuilder>
{


    public AssociationsCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
