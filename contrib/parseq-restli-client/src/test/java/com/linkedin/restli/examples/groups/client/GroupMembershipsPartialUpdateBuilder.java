...
public class GroupMembershipsPartialUpdateBuilder
    extends PartialUpdateRequestBuilderBase<CompoundKey, GroupMembership, GroupMembershipsPartialUpdateBuilder>
{


    public GroupMembershipsPartialUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
