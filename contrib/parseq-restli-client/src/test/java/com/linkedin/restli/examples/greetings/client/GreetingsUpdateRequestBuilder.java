...
public class GreetingsUpdateRequestBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, GreetingsUpdateRequestBuilder>
{


    public GreetingsUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
