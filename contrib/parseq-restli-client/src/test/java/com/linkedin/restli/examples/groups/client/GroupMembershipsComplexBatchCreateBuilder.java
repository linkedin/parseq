...
public class GroupMembershipsComplexBatchCreateBuilder
    extends BatchCreateRequestBuilderBase<ComplexResourceKey<GroupMembershipKey, GroupMembershipParam> , ComplexKeyGroupMembership, GroupMembershipsComplexBatchCreateBuilder>
{


    public GroupMembershipsComplexBatchCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
