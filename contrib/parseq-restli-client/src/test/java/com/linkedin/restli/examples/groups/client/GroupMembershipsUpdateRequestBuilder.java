...
public class GroupMembershipsUpdateRequestBuilder
    extends UpdateRequestBuilderBase<CompoundKey, GroupMembership, GroupMembershipsUpdateRequestBuilder>
{


    public GroupMembershipsUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
