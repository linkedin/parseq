...
public class ValidationDemosBatchUpdateRequestBuilder
    extends BatchUpdateRequestBuilderBase<Integer, ValidationDemo, ValidationDemosBatchUpdateRequestBuilder>
{


    public ValidationDemosBatchUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
