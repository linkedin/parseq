...
public class GreetingsPromiseBatchCreateRequestBuilder
    extends BatchCreateIdRequestBuilderBase<Long, Greeting, GreetingsPromiseBatchCreateRequestBuilder>
{


    public GreetingsPromiseBatchCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
