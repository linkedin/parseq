...
public class AutoValidationDemosBatchCreateAndGetBuilder
    extends BatchCreateIdEntityRequestBuilderBase<Integer, ValidationDemo, AutoValidationDemosBatchCreateAndGetBuilder>
{


    public AutoValidationDemosBatchCreateAndGetBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
