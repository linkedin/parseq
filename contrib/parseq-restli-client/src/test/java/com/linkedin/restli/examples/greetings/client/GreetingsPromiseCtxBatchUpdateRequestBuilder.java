...
public class GreetingsPromiseCtxBatchUpdateRequestBuilder
    extends BatchUpdateRequestBuilderBase<Long, Greeting, GreetingsPromiseCtxBatchUpdateRequestBuilder>
{


    public GreetingsPromiseCtxBatchUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
