...
public class SubgreetingsPartialUpdateBuilder
    extends PartialUpdateRequestBuilderBase<Long, Greeting, SubgreetingsPartialUpdateBuilder>
{


    public SubgreetingsPartialUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
