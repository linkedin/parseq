...
public class ValidationDemosUpdateRequestBuilder
    extends UpdateRequestBuilderBase<Integer, ValidationDemo, ValidationDemosUpdateRequestBuilder>
{


    public ValidationDemosUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
