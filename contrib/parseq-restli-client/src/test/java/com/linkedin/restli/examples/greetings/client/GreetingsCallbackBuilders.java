...
public class GreetingsCallbackBuilders {
    ...
    public GreetingsCallbackBuilders() {
        this(RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public GreetingsCallbackBuilders(RestliRequestOptions requestOptions) {
        _baseUriTemplate = ORIGINAL_RESOURCE_PATH;
        _requestOptions = assignRequestOptions(requestOptions);
    }

    public GreetingsCallbackBuilders(java.lang.String primaryResourceName) {
        this(primaryResourceName, RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public GreetingsCallbackBuilders(java.lang.String primaryResourceName, RestliRequestOptions requestOptions) {
    ...
    public GreetingsCallbackBatchGetBuilder batchGet() {
        return new GreetingsCallbackBatchGetBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackBatchUpdateBuilder batchUpdate() {
        return new GreetingsCallbackBatchUpdateBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackBatchDeleteBuilder batchDelete() {
        return new GreetingsCallbackBatchDeleteBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackGetAllBuilder getAll() {
        return new GreetingsCallbackGetAllBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackDeleteBuilder delete() {
        return new GreetingsCallbackDeleteBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackBatchCreateBuilder batchCreate() {
        return new GreetingsCallbackBatchCreateBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackCreateBuilder create() {
        return new GreetingsCallbackCreateBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackUpdateBuilder update() {
        return new GreetingsCallbackUpdateBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackGetBuilder get() {
        return new GreetingsCallbackGetBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackBatchPartialUpdateBuilder batchPartialUpdate() {
        return new GreetingsCallbackBatchPartialUpdateBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackPartialUpdateBuilder partialUpdate() {
        return new GreetingsCallbackPartialUpdateBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackFindByEmptyBuilder findByEmpty() {
        return new GreetingsCallbackFindByEmptyBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackFindBySearchBuilder findBySearch() {
        return new GreetingsCallbackFindBySearchBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackFindBySearchWithDefaultBuilder findBySearchWithDefault() {
        return new GreetingsCallbackFindBySearchWithDefaultBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackFindBySearchWithFacetsBuilder findBySearchWithFacets() {
        return new GreetingsCallbackFindBySearchWithFacetsBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackFindBySearchWithPostFilterBuilder findBySearchWithPostFilter() {
        return new GreetingsCallbackFindBySearchWithPostFilterBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackFindBySearchWithTonesBuilder findBySearchWithTones() {
        return new GreetingsCallbackFindBySearchWithTonesBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackDoAnotherActionBuilder actionAnotherAction() {
        return new GreetingsCallbackDoAnotherActionBuilder(getBaseUriTemplate(), Void.class, _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackDoExceptionTestBuilder actionExceptionTest() {
        return new GreetingsCallbackDoExceptionTestBuilder(getBaseUriTemplate(), Void.class, _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackDoPurgeBuilder actionPurge() {
        return new GreetingsCallbackDoPurgeBuilder(getBaseUriTemplate(), Integer.class, _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackDoSomeActionBuilder actionSomeAction() {
        return new GreetingsCallbackDoSomeActionBuilder(getBaseUriTemplate(), Greeting.class, _resourceSpec, getRequestOptions());
    }

    public GreetingsCallbackDoUpdateToneBuilder actionUpdateTone() {
        return new GreetingsCallbackDoUpdateToneBuilder(getBaseUriTemplate(), Greeting.class, _resourceSpec, getRequestOptions());
    }
