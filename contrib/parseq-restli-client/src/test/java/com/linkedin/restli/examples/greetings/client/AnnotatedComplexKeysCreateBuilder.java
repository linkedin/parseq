...
public class AnnotatedComplexKeysCreateBuilder
    extends CreateRequestBuilderBase<ComplexResourceKey<TwoPartKey, TwoPartKey> , Message, AnnotatedComplexKeysCreateBuilder>
{


    public AnnotatedComplexKeysCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
