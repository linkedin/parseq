...
public class GroupMembershipsComplexBatchUpdateBuilder
    extends BatchUpdateRequestBuilderBase<ComplexResourceKey<GroupMembershipKey, GroupMembershipParam> , ComplexKeyGroupMembership, GroupMembershipsComplexBatchUpdateBuilder>
{


    public GroupMembershipsComplexBatchUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
