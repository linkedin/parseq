...
public class GreetingsBatchCreateRequestBuilder
    extends BatchCreateIdRequestBuilderBase<Long, Greeting, GreetingsBatchCreateRequestBuilder>
{


    public GreetingsBatchCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
