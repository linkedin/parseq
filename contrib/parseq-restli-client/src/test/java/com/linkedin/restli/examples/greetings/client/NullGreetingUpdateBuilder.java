...
public class NullGreetingUpdateBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, NullGreetingUpdateBuilder>
{


    public NullGreetingUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
