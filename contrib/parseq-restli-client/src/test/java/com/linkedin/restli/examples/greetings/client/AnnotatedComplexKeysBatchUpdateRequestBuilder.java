...
public class AnnotatedComplexKeysBatchUpdateRequestBuilder
    extends BatchUpdateRequestBuilderBase<ComplexResourceKey<TwoPartKey, TwoPartKey> , Message, AnnotatedComplexKeysBatchUpdateRequestBuilder>
{


    public AnnotatedComplexKeysBatchUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
