...
public class AutoValidationDemosBatchUpdateRequestBuilder
    extends BatchUpdateRequestBuilderBase<Integer, ValidationDemo, AutoValidationDemosBatchUpdateRequestBuilder>
{


    public AutoValidationDemosBatchUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public static ValidationResult validateInput(ValidationDemo input) {
        ...
        RestLiDataValidator validator = new RestLiDataValidator(annotations, ValidationDemo.class, ResourceMethod.BATCH_UPDATE);
