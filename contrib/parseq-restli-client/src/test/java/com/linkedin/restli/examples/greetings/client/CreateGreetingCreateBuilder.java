...
public class CreateGreetingCreateBuilder
    extends CreateRequestBuilderBase<Long, Greeting, CreateGreetingCreateBuilder>
{


    public CreateGreetingCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
