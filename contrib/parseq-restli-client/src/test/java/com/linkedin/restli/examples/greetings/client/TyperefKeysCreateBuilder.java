...
public class TyperefKeysCreateBuilder
    extends CreateRequestBuilderBase<Long, Greeting, TyperefKeysCreateBuilder>
{


    public TyperefKeysCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
