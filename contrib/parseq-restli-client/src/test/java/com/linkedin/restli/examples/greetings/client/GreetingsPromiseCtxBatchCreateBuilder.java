...
public class GreetingsPromiseCtxBatchCreateBuilder
    extends BatchCreateRequestBuilderBase<Long, Greeting, GreetingsPromiseCtxBatchCreateBuilder>
{


    public GreetingsPromiseCtxBatchCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
