...
public class GreetingsPromiseBatchCreateBuilder
    extends BatchCreateRequestBuilderBase<Long, Greeting, GreetingsPromiseBatchCreateBuilder>
{


    public GreetingsPromiseBatchCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
