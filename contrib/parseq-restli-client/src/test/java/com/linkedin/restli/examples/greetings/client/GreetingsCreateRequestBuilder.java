...
public class GreetingsCreateRequestBuilder
    extends CreateIdRequestBuilderBase<Long, Greeting, GreetingsCreateRequestBuilder>
{


    public GreetingsCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public GreetingsCreateRequestBuilder isNullIdParam(Boolean value) {
