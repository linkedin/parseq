...
public class GroupMembershipsPartialUpdateRequestBuilder
    extends PartialUpdateRequestBuilderBase<CompoundKey, GroupMembership, GroupMembershipsPartialUpdateRequestBuilder>
{


    public GroupMembershipsPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public static ValidationResult validateInput(PatchRequest<GroupMembership> patch) {
        ...
        RestLiDataValidator validator = new RestLiDataValidator(annotations, GroupMembership.class, ResourceMethod.PARTIAL_UPDATE);
