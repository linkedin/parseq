...
public class SubgreetingsCreateRequestBuilder
    extends CreateIdRequestBuilderBase<Long, Greeting, SubgreetingsCreateRequestBuilder>
{


    public SubgreetingsCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
