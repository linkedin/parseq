...
public class GreetingsCallbackCreateBuilder
    extends CreateRequestBuilderBase<Long, Greeting, GreetingsCallbackCreateBuilder>
{


    public GreetingsCallbackCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public GreetingsCallbackCreateBuilder isNullIdParam(Boolean value) {
