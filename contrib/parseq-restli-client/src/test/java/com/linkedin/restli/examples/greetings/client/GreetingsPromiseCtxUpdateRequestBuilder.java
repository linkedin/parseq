...
public class GreetingsPromiseCtxUpdateRequestBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, GreetingsPromiseCtxUpdateRequestBuilder>
{


    public GreetingsPromiseCtxUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
