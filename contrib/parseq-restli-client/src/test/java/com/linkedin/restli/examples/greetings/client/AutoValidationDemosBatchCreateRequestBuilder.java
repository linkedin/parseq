...
public class AutoValidationDemosBatchCreateRequestBuilder
    extends BatchCreateIdRequestBuilderBase<Integer, ValidationDemo, AutoValidationDemosBatchCreateRequestBuilder>
{


    public AutoValidationDemosBatchCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
