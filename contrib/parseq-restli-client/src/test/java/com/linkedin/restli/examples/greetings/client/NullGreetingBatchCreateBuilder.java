...
public class NullGreetingBatchCreateBuilder
    extends BatchCreateRequestBuilderBase<Long, Greeting, NullGreetingBatchCreateBuilder>
{


    public NullGreetingBatchCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
