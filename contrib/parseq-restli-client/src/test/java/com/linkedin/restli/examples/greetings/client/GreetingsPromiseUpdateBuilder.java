...
public class GreetingsPromiseUpdateBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, GreetingsPromiseUpdateBuilder>
{


    public GreetingsPromiseUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
