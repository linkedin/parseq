...
public class GreetingsCallbackBatchCreateBuilder
    extends BatchCreateRequestBuilderBase<Long, Greeting, GreetingsCallbackBatchCreateBuilder>
{


    public GreetingsCallbackBatchCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
