...
public class GreetingsCallbackUpdateRequestBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, GreetingsCallbackUpdateRequestBuilder>
{


    public GreetingsCallbackUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
