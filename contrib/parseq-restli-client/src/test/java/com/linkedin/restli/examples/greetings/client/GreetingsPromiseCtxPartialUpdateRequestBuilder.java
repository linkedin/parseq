...
public class GreetingsPromiseCtxPartialUpdateRequestBuilder
    extends PartialUpdateRequestBuilderBase<Long, Greeting, GreetingsPromiseCtxPartialUpdateRequestBuilder>
{


    public GreetingsPromiseCtxPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
