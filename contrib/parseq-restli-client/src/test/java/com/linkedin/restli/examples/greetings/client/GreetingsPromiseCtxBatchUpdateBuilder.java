...
public class GreetingsPromiseCtxBatchUpdateBuilder
    extends BatchUpdateRequestBuilderBase<Long, Greeting, GreetingsPromiseCtxBatchUpdateBuilder>
{


    public GreetingsPromiseCtxBatchUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
