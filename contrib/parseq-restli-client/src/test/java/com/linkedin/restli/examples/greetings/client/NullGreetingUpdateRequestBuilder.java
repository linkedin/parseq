...
public class NullGreetingUpdateRequestBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, NullGreetingUpdateRequestBuilder>
{


    public NullGreetingUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
