...
public class GreetingsPartialUpdateRequestBuilder
    extends PartialUpdateRequestBuilderBase<Long, Greeting, GreetingsPartialUpdateRequestBuilder>
{


    public GreetingsPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
