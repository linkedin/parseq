...
public class GreetingsTaskBatchUpdateRequestBuilder
    extends BatchUpdateRequestBuilderBase<Long, Greeting, GreetingsTaskBatchUpdateRequestBuilder>
{


    public GreetingsTaskBatchUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
