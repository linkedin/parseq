...
public class GreetingsAuthUpdateBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, GreetingsAuthUpdateBuilder>
{


    public GreetingsAuthUpdateBuilder(java.lang.String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public GreetingsAuthUpdateBuilder authParam(java.lang.String value) {
