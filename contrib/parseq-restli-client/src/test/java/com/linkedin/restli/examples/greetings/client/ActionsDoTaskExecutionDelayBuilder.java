...
public class ActionsDoTaskExecutionDelayBuilder
    extends ActionRequestBuilderBase<Void, Void, ActionsDoTaskExecutionDelayBuilder>
{


    public ActionsDoTaskExecutionDelayBuilder(String baseUriTemplate, Class<Void> returnClass, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
        super(baseUriTemplate, returnClass, resourceSpec, requestOptions);
        super.name("taskExecutionDelay");
    }

    public ActionsDoTaskExecutionDelayBuilder paramDelay(Integer value) {
