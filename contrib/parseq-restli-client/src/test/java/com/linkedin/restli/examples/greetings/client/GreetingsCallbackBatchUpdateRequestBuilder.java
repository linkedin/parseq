...
public class GreetingsCallbackBatchUpdateRequestBuilder
    extends BatchUpdateRequestBuilderBase<Long, Greeting, GreetingsCallbackBatchUpdateRequestBuilder>
{


    public GreetingsCallbackBatchUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
