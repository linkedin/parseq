...
public class ChainedTyperefsBatchUpdateBuilder
    extends BatchUpdateRequestBuilderBase<CompoundKey, Greeting, ChainedTyperefsBatchUpdateBuilder>
{


    public ChainedTyperefsBatchUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
