...
public class Exceptions3UpdateBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, Exceptions3UpdateBuilder>
{


    public Exceptions3UpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
