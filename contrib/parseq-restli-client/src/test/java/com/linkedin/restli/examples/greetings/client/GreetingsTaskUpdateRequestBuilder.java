...
public class GreetingsTaskUpdateRequestBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, GreetingsTaskUpdateRequestBuilder>
{


    public GreetingsTaskUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
