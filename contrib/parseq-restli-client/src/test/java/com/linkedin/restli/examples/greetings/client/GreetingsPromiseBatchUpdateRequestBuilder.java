...
public class GreetingsPromiseBatchUpdateRequestBuilder
    extends BatchUpdateRequestBuilderBase<Long, Greeting, GreetingsPromiseBatchUpdateRequestBuilder>
{


    public GreetingsPromiseBatchUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
