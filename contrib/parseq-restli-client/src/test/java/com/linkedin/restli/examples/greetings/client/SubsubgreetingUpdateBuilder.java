...
public class SubsubgreetingUpdateBuilder
    extends UpdateRequestBuilderBase<Void, Greeting, SubsubgreetingUpdateBuilder>
{


    public SubsubgreetingUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public SubsubgreetingUpdateBuilder subgreetingsIdKey(Long key) {
