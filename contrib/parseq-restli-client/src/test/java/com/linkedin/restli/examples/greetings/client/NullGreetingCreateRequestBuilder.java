...
public class NullGreetingCreateRequestBuilder
    extends CreateIdRequestBuilderBase<Long, Greeting, NullGreetingCreateRequestBuilder>
{


    public NullGreetingCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
