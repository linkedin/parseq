...
public class ComplexKeysBatchUpdateRequestBuilder
    extends BatchUpdateRequestBuilderBase<ComplexResourceKey<TwoPartKey, TwoPartKey> , Message, ComplexKeysBatchUpdateRequestBuilder>
{


    public ComplexKeysBatchUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
