...
public class StreamingGreetingsUpdateRequestBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, StreamingGreetingsUpdateRequestBuilder>
{


    public StreamingGreetingsUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
