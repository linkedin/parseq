...
public class GreetingsPromisePartialUpdateRequestBuilder
    extends PartialUpdateRequestBuilderBase<Long, Greeting, GreetingsPromisePartialUpdateRequestBuilder>
{


    public GreetingsPromisePartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
