...
public class MixedCreateBuilder
    extends CreateRequestBuilderBase<Long, Greeting, MixedCreateBuilder>
{


    public MixedCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
