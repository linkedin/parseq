...
public class GreetingsPartialUpdateBuilder
    extends PartialUpdateRequestBuilderBase<Long, Greeting, GreetingsPartialUpdateBuilder>
{


    public GreetingsPartialUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
