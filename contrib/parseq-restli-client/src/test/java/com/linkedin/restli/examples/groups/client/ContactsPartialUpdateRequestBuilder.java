...
public class ContactsPartialUpdateRequestBuilder
    extends PartialUpdateRequestBuilderBase<Integer, GroupContact, ContactsPartialUpdateRequestBuilder>
{


    public ContactsPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public ContactsPartialUpdateRequestBuilder groupIdKey(Integer key) {
