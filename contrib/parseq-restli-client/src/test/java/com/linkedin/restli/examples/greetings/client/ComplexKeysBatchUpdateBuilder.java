...
public class ComplexKeysBatchUpdateBuilder
    extends BatchUpdateRequestBuilderBase<ComplexResourceKey<TwoPartKey, TwoPartKey> , Message, ComplexKeysBatchUpdateBuilder>
{


    public ComplexKeysBatchUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
