...
public class CustomTypes2BatchCreateBuilder
    extends BatchCreateRequestBuilderBase<CustomLong, Greeting, CustomTypes2BatchCreateBuilder>
{


    public CustomTypes2BatchCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
