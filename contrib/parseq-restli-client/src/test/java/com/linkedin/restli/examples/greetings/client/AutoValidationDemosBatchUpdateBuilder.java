...
public class AutoValidationDemosBatchUpdateBuilder
    extends BatchUpdateRequestBuilderBase<Integer, ValidationDemo, AutoValidationDemosBatchUpdateBuilder>
{


    public AutoValidationDemosBatchUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
