...
public class AssociationsBatchUpdateRequestBuilder
    extends BatchUpdateRequestBuilderBase<CompoundKey, Message, AssociationsBatchUpdateRequestBuilder>
{


    public AssociationsBatchUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
