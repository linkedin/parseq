...
public class CreateGreetingCreateAndGetBuilder
    extends CreateIdEntityRequestBuilderBase<Long, Greeting, CreateGreetingCreateAndGetBuilder>
{


    public CreateGreetingCreateAndGetBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
