...
public class ValidationDemosBatchPartialUpdateRequestBuilder
    extends BatchPartialUpdateRequestBuilderBase<Integer, ValidationDemo, ValidationDemosBatchPartialUpdateRequestBuilder>
{


    public ValidationDemosBatchPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
