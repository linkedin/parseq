...
public class ValidationDemosBatchCreateRequestBuilder
    extends BatchCreateIdRequestBuilderBase<Integer, ValidationDemo, ValidationDemosBatchCreateRequestBuilder>
{


    public ValidationDemosBatchCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
