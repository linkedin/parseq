...
public class GreetingsCallbackPartialUpdateRequestBuilder
    extends PartialUpdateRequestBuilderBase<Long, Greeting, GreetingsCallbackPartialUpdateRequestBuilder>
{


    public GreetingsCallbackPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
