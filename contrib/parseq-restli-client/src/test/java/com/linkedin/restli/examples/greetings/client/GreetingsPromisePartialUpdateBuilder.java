...
public class GreetingsPromisePartialUpdateBuilder
    extends PartialUpdateRequestBuilderBase<Long, Greeting, GreetingsPromisePartialUpdateBuilder>
{


    public GreetingsPromisePartialUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
