...
public class ValidationDemosBatchCreateBuilder
    extends BatchCreateRequestBuilderBase<Integer, ValidationDemo, ValidationDemosBatchCreateBuilder>
{


    public ValidationDemosBatchCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
