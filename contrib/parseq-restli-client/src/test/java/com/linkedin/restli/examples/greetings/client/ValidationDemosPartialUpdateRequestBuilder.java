...
public class ValidationDemosPartialUpdateRequestBuilder
    extends PartialUpdateRequestBuilderBase<Integer, ValidationDemo, ValidationDemosPartialUpdateRequestBuilder>
{


    public ValidationDemosPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
