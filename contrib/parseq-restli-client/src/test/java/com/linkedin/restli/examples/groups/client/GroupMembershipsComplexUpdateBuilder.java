...
public class GroupMembershipsComplexUpdateBuilder
    extends UpdateRequestBuilderBase<ComplexResourceKey<GroupMembershipKey, GroupMembershipParam> , ComplexKeyGroupMembership, GroupMembershipsComplexUpdateBuilder>
{


    public GroupMembershipsComplexUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
