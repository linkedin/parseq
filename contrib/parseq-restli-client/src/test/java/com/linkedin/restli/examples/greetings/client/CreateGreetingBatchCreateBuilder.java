...
public class CreateGreetingBatchCreateBuilder
    extends BatchCreateRequestBuilderBase<Long, Greeting, CreateGreetingBatchCreateBuilder>
{


    public CreateGreetingBatchCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
