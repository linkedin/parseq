...
public class NullGreetingBatchUpdateRequestBuilder
    extends BatchUpdateRequestBuilderBase<Long, Greeting, NullGreetingBatchUpdateRequestBuilder>
{


    public NullGreetingBatchUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
