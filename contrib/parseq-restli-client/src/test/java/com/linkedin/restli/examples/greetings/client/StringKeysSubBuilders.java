...
public class StringKeysSubBuilders {
    ...
    public StringKeysSubBuilders() {
        this(RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public StringKeysSubBuilders(RestliRequestOptions requestOptions) {
        _baseUriTemplate = ORIGINAL_RESOURCE_PATH;
        _requestOptions = assignRequestOptions(requestOptions);
    }

    public StringKeysSubBuilders(java.lang.String primaryResourceName) {
        this(primaryResourceName, RestliRequestOptions.DEFAULT_OPTIONS);
    }

    public StringKeysSubBuilders(java.lang.String primaryResourceName, RestliRequestOptions requestOptions) {
    ...
    public StringKeysSubGetBuilder get() {
        return new StringKeysSubGetBuilder(getBaseUriTemplate(), _resourceSpec, getRequestOptions());
    }
