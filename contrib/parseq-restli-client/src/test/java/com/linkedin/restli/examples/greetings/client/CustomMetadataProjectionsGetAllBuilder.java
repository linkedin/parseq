...
public class CustomMetadataProjectionsGetAllBuilder
    extends GetAllRequestBuilderBase<Long, Greeting, CustomMetadataProjectionsGetAllBuilder>
{


    public CustomMetadataProjectionsGetAllBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
