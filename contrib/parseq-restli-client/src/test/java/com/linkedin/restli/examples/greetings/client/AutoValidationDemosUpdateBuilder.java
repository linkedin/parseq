...
public class AutoValidationDemosUpdateBuilder
    extends UpdateRequestBuilderBase<Integer, ValidationDemo, AutoValidationDemosUpdateBuilder>
{


    public AutoValidationDemosUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
