...
public class GreetingsPromiseCtxUpdateBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, GreetingsPromiseCtxUpdateBuilder>
{


    public GreetingsPromiseCtxUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
