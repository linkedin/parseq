...
public class ValidationDemosBatchUpdateBuilder
    extends BatchUpdateRequestBuilderBase<Integer, ValidationDemo, ValidationDemosBatchUpdateBuilder>
{


    public ValidationDemosBatchUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
