...
public class GroupMembershipsBatchPartialUpdateRequestBuilder
    extends BatchPartialUpdateRequestBuilderBase<CompoundKey, GroupMembership, GroupMembershipsBatchPartialUpdateRequestBuilder>
{


    public GroupMembershipsBatchPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
