...
public class StreamingGreetingsUpdateBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, StreamingGreetingsUpdateBuilder>
{


    public StreamingGreetingsUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
