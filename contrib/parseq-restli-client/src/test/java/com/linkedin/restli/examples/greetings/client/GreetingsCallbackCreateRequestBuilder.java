...
public class GreetingsCallbackCreateRequestBuilder
    extends CreateIdRequestBuilderBase<Long, Greeting, GreetingsCallbackCreateRequestBuilder>
{


    public GreetingsCallbackCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public GreetingsCallbackCreateRequestBuilder isNullIdParam(Boolean value) {
