...
public class ValidationDemosPartialUpdateBuilder
    extends PartialUpdateRequestBuilderBase<Integer, ValidationDemo, ValidationDemosPartialUpdateBuilder>
{


    public ValidationDemosPartialUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
