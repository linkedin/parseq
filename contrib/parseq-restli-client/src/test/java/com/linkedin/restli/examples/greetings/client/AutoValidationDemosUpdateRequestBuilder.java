...
public class AutoValidationDemosUpdateRequestBuilder
    extends UpdateRequestBuilderBase<Integer, ValidationDemo, AutoValidationDemosUpdateRequestBuilder>
{


    public AutoValidationDemosUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
