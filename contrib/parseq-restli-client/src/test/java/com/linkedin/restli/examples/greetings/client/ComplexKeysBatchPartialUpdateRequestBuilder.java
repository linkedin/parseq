...
public class ComplexKeysBatchPartialUpdateRequestBuilder
    extends BatchPartialUpdateRequestBuilderBase<ComplexResourceKey<TwoPartKey, TwoPartKey> , Message, ComplexKeysBatchPartialUpdateRequestBuilder>
{


    public ComplexKeysBatchPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
