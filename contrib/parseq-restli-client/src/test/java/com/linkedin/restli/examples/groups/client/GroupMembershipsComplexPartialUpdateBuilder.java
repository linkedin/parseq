...
public class GroupMembershipsComplexPartialUpdateBuilder
    extends PartialUpdateRequestBuilderBase<ComplexResourceKey<GroupMembershipKey, GroupMembershipParam> , ComplexKeyGroupMembership, GroupMembershipsComplexPartialUpdateBuilder>
{


    public GroupMembershipsComplexPartialUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
