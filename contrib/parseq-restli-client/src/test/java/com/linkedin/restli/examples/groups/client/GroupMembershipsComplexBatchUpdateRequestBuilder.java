...
public class GroupMembershipsComplexBatchUpdateRequestBuilder
    extends BatchUpdateRequestBuilderBase<ComplexResourceKey<GroupMembershipKey, GroupMembershipParam> , ComplexKeyGroupMembership, GroupMembershipsComplexBatchUpdateRequestBuilder>
{


    public GroupMembershipsComplexBatchUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public static ValidationResult validateInput(ComplexKeyGroupMembership input) {
        ...
        RestLiDataValidator validator = new RestLiDataValidator(annotations, ComplexKeyGroupMembership.class, ResourceMethod.BATCH_UPDATE);
