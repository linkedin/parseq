...
public class GreetingsPromiseCreateRequestBuilder
    extends CreateIdRequestBuilderBase<Long, Greeting, GreetingsPromiseCreateRequestBuilder>
{


    public GreetingsPromiseCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public GreetingsPromiseCreateRequestBuilder isNullIdParam(Boolean value) {
