...
public class SubsubgreetingPartialUpdateRequestBuilder
    extends PartialUpdateRequestBuilderBase<Void, Greeting, SubsubgreetingPartialUpdateRequestBuilder>
{


    public SubsubgreetingPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public SubsubgreetingPartialUpdateRequestBuilder subgreetingsIdKey(Long key) {
