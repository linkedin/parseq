...
public class CreateGreetingCreateAndGetRequestBuilder
    extends CreateIdEntityRequestBuilderBase<Long, Greeting, CreateGreetingCreateAndGetRequestBuilder>
{


    public CreateGreetingCreateAndGetRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
