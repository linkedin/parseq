...
public class SubgreetingsBatchCreateRequestBuilder
    extends BatchCreateIdRequestBuilderBase<Long, Greeting, SubgreetingsBatchCreateRequestBuilder>
{


    public SubgreetingsBatchCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
