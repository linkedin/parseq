...
public class CreateGreetingBatchCreateRequestBuilder
    extends BatchCreateIdRequestBuilderBase<Long, Greeting, CreateGreetingBatchCreateRequestBuilder>
{


    public CreateGreetingBatchCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
