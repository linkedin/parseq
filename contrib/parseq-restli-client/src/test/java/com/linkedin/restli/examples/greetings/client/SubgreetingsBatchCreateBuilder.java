...
public class SubgreetingsBatchCreateBuilder
    extends BatchCreateRequestBuilderBase<Long, Greeting, SubgreetingsBatchCreateBuilder>
{


    public SubgreetingsBatchCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
