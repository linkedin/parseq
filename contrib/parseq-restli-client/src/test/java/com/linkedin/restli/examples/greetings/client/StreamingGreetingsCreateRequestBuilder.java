...
public class StreamingGreetingsCreateRequestBuilder
    extends CreateIdRequestBuilderBase<Long, Greeting, StreamingGreetingsCreateRequestBuilder>
{


    public StreamingGreetingsCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
