...
public class ComplexKeysBatchCreateBuilder
    extends BatchCreateRequestBuilderBase<ComplexResourceKey<TwoPartKey, TwoPartKey> , Message, ComplexKeysBatchCreateBuilder>
{


    public ComplexKeysBatchCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
