...
public class CustomTypes2BatchUpdateBuilder
    extends BatchUpdateRequestBuilderBase<CustomLong, Greeting, CustomTypes2BatchUpdateBuilder>
{


    public CustomTypes2BatchUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
