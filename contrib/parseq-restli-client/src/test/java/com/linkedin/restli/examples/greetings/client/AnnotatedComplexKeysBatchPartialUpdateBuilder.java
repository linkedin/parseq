...
public class AnnotatedComplexKeysBatchPartialUpdateBuilder
    extends BatchPartialUpdateRequestBuilderBase<ComplexResourceKey<TwoPartKey, TwoPartKey> , Message, AnnotatedComplexKeysBatchPartialUpdateBuilder>
{


    public AnnotatedComplexKeysBatchPartialUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
