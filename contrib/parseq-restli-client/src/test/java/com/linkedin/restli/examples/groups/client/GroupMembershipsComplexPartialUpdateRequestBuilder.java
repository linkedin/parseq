...
public class GroupMembershipsComplexPartialUpdateRequestBuilder
    extends PartialUpdateRequestBuilderBase<ComplexResourceKey<GroupMembershipKey, GroupMembershipParam> , ComplexKeyGroupMembership, GroupMembershipsComplexPartialUpdateRequestBuilder>
{


    public GroupMembershipsComplexPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public static ValidationResult validateInput(PatchRequest<ComplexKeyGroupMembership> patch) {
        ...
        RestLiDataValidator validator = new RestLiDataValidator(annotations, ComplexKeyGroupMembership.class, ResourceMethod.PARTIAL_UPDATE);
