...
public class CreateGreetingBatchCreateAndGetBuilder
    extends BatchCreateIdEntityRequestBuilderBase<Long, Greeting, CreateGreetingBatchCreateAndGetBuilder>
{


    public CreateGreetingBatchCreateAndGetBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
