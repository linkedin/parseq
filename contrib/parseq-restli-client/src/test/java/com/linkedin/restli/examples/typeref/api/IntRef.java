    ...
    extends TyperefInfo
{
    ...
    private final static TyperefDataSchema SCHEMA = ((TyperefDataSchema) DataTemplateUtil.parseSchema("{\"type\":\"typeref\",\"name\":\"IntRef\",\"namespace\":\"com.linkedin.restli.examples.typeref.api\",\"ref\":\"int\"}"));
