...
public class GroupMembershipsComplexCreateRequestBuilder
    extends CreateIdRequestBuilderBase<ComplexResourceKey<GroupMembershipKey, GroupMembershipParam> , ComplexKeyGroupMembership, GroupMembershipsComplexCreateRequestBuilder>
{


    public GroupMembershipsComplexCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public static ValidationResult validateInput(ComplexKeyGroupMembership input) {
        ...
        RestLiDataValidator validator = new RestLiDataValidator(annotations, ComplexKeyGroupMembership.class, ResourceMethod.CREATE);
