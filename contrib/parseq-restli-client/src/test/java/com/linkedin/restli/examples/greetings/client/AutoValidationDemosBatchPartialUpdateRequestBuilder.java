...
public class AutoValidationDemosBatchPartialUpdateRequestBuilder
    extends BatchPartialUpdateRequestBuilderBase<Integer, ValidationDemo, AutoValidationDemosBatchPartialUpdateRequestBuilder>
{


    public AutoValidationDemosBatchPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
