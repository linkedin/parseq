...
public class GreetingsTaskPartialUpdateRequestBuilder
    extends PartialUpdateRequestBuilderBase<Long, Greeting, GreetingsTaskPartialUpdateRequestBuilder>
{


    public GreetingsTaskPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
