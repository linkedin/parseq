...
public class AnnotatedComplexKeysPartialUpdateBuilder
    extends PartialUpdateRequestBuilderBase<ComplexResourceKey<TwoPartKey, TwoPartKey> , Message, AnnotatedComplexKeysPartialUpdateBuilder>
{


    public AnnotatedComplexKeysPartialUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
