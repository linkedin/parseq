...
public class ContactsCreateRequestBuilder
    extends CreateIdRequestBuilderBase<Integer, GroupContact, ContactsCreateRequestBuilder>
{


    public ContactsCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
    ...
    public ContactsCreateRequestBuilder groupIdKey(Integer key) {
