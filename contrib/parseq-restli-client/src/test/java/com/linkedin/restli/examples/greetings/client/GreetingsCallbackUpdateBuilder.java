...
public class GreetingsCallbackUpdateBuilder
    extends UpdateRequestBuilderBase<Long, Greeting, GreetingsCallbackUpdateBuilder>
{


    public GreetingsCallbackUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
