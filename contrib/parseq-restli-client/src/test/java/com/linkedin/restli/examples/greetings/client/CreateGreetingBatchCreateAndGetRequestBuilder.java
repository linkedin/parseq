...
public class CreateGreetingBatchCreateAndGetRequestBuilder
    extends BatchCreateIdEntityRequestBuilderBase<Long, Greeting, CreateGreetingBatchCreateAndGetRequestBuilder>
{


    public CreateGreetingBatchCreateAndGetRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
