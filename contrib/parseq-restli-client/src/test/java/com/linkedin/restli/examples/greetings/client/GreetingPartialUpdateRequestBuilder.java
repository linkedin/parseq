...
public class GreetingPartialUpdateRequestBuilder
    extends PartialUpdateRequestBuilderBase<Void, Greeting, GreetingPartialUpdateRequestBuilder>
{


    public GreetingPartialUpdateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
