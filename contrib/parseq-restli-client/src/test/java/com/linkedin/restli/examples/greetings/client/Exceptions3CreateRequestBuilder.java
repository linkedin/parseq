...
public class Exceptions3CreateRequestBuilder
    extends CreateIdRequestBuilderBase<Long, Greeting, Exceptions3CreateRequestBuilder>
{


    public Exceptions3CreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
