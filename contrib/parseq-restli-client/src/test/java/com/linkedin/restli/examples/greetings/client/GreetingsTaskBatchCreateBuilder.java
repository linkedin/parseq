...
public class GreetingsTaskBatchCreateBuilder
    extends BatchCreateRequestBuilderBase<Long, Greeting, GreetingsTaskBatchCreateBuilder>
{


    public GreetingsTaskBatchCreateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
