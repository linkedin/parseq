...
public class GreetingsTaskBatchUpdateBuilder
    extends BatchUpdateRequestBuilderBase<Long, Greeting, GreetingsTaskBatchUpdateBuilder>
{


    public GreetingsTaskBatchUpdateBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
