...
public class MixedCreateRequestBuilder
    extends CreateIdRequestBuilderBase<Long, Greeting, MixedCreateRequestBuilder>
{


    public MixedCreateRequestBuilder(String baseUriTemplate, ResourceSpec resourceSpec, RestliRequestOptions requestOptions) {
